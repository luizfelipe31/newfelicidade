...
<style>
    body {
    background: url(<?=url("shared/images/background-image.jpg")?>) fixed no-repeat;
...
<body class="hold-transition login-page" style='background-image: url("<?=url("shared/images/background-image.jpg")?>") fixed no-repeat;'>
