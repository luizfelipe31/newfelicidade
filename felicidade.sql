...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Jun-2021 às 22:14
...
CREATE TABLE `invoices` (
  ...
  `bank_account_id` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `invoices` (`id`, `cod`, `value`, `operation`, `category`, `bank_account_id`, `wallet`, `reference_date`, `due_date`, `contract`, `property`, `lessor`, `note`, `fixed`, `recurrent`, `compensation_date`, `compensation_value`, `compensation_type`, `status_comission`, `status`, `account_id`, `created_at`, `updated_at`) VALUES
